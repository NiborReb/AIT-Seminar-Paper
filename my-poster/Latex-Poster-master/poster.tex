...
\headerbox{\textsf{System Model}}{name=abschnitt2,column=0, span=3, below=abschnitt1}{
	\vspace{0.5em}
	\begin{itemize}[leftmargin=5.5mm, rightmargin=5.5mm]
		\item Both describe the same realistic biological scenario with distinct zones: the artery (blood inlet), vein (blood outlet), capillary network (\(\Omega_c)\), tumor area (\(\Omega_t)\), and healthy tissue (\(\Omega_h)\)
		\item 
	\end{itemize}
	\vspace{0.5em}
}

...
\headerbox{}{name=headtext, column=0, span=5, textborder=none, headerborder=none, boxheaderheight=0pt, boxColorOne=uzl_oceangreen_80}{
  \vspace{0.10cm}
    \textcolor{white}{\textsf{\large{Robin Brendel  \hfill - \hfill Universität zu Lübeck \hfill - \hfill Institut für Telematik - \hfill Email: robin.brendel@student.uni-luebeck.de}}}
  \vspace{0.10cm}
}
...
%%% References %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{\textsf{References}}{name=references, column=0, span=3, above=bottom, below=abschnitt4}{
  \begin{small}
